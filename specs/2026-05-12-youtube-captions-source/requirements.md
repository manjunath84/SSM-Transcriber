...
1. **Happy path — manual captions.** User runs
   ...
   resolves the video ID, fetches the caption track, fetches the
   oembed title in parallel, writes
   `./output/<oembed-title>-2026-05-12.md` with frontmatter
   `caption_type: manual`. Exit `0`.
